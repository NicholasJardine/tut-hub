...
export default function Dashboard() {
  ...
  const getStudentName = (studentId: number) => {
    return <div> <p className='tag-4 whitespace-nowrap'> booking {studentId} </p> </div>;
  };
                  ...
                  return (
                    <div
                      ...
                      className={`border border-gray-300 p-6 flex justify-center items-center ${
                        selectedDate.getDate() === dayObj.dayNumber ? "bg-blue-100" : matchingBooking ? "bg-amber-300" : isUnavailable ? "bg-red-300" : "bg-green-200"
                      } hover:opacity-50`}
                    ...
                    >
                      {matchingBooking ? (
                        ...
                        <div><p className='tag-6'>Unavailable</p></div>
